...
#define    IDM_FORMAT    (IDM + 5000)
    ...
    #define    IDM_FORMAT_JOHAP             (IDM_FORMAT_ENCODE + 45)
    #define    IDM_FORMAT_TIS_620           (IDM_FORMAT_ENCODE + 46)
    #define    IDM_FORMAT_MAC_CYRILLIC      (IDM_FORMAT_ENCODE + 47)
    #define    IDM_FORMAT_KOI8U_CYRILLIC    (IDM_FORMAT_ENCODE + 48)
    #define    IDM_FORMAT_KOI8R_CYRILLIC    (IDM_FORMAT_ENCODE + 49)
